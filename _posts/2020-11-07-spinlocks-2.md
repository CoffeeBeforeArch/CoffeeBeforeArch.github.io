...
A relatively minor change to our code (replacing reads with writes) lead to a huge improvement in performance. However, there is still plenty of room for improvement in our implementation, especially in how control how fast or threads read the spinlock state.
